...
//从发送数据
I2C_ErrorDef I2C_SlaveSendDataToMaster(I2C_TypeDef *I2Cx, uint8_t *pu8Data, uint32_t u32Len);
//从接收数据
I2C_ErrorDef I2C_SlaveRecDataFromMaster(I2C_TypeDef *I2Cx, uint8_t *pu8Data, uint32_t *pu32Len);
...
//禁止I2C的中断
void I2C_DisableInt(I2C_TypeDef *I2Cx);
//使能I2C的中断
void I2C_EnableInt(I2C_TypeDef *I2Cx);
